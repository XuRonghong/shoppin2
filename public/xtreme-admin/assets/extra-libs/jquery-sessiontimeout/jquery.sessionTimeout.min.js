    ...
    e.sessionTimeout = function(t) {
        ...
        if ("function" != typeof d.onWarn) {
            var u = d.countdownMessage ? "<p>" + d.countdownMessage.replace(/{timer}/g, '<span class="countdown-holder"></span>') + "</p>" : "",
                c = d.countdownBar ? '<div class="progress" style="height: 15px;">                   <div class="progress-bar bg-meta countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;">                     <span class="countdown-holder"></span>                   </div>                 </div>' : "";
